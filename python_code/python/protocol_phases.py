...
def enrollment(csr_id: str,attempt: str, case: str, txt_enr: str, nonces:str):
    ...
    return send_message_bytes, time_proc, time_gen, time_Kgen, time_sign
        ...
        try:
            ...
            if R == "{0:d}".format(int(0.0)):
                ...
                if (in_pk==str(pubkey)):
                    ...
                    return 1,time_ver, time_proc, time_rep, time_Kgen,time_comp
                else: 
                    time_comp = time.time() - time_comp1
                    print('[system] ERROR: Not valid verification key')
                    return 0,time_ver, time_proc, time_rep, time_Kgen, time_comp
        except KeyError:
